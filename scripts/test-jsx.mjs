...
const FILES = ["src/visuals.test.jsx", "src/wizard.test.jsx", "src/steps.test.jsx", "src/ceiling.test.jsx", "src/order.test.jsx", "src/ticket.test.jsx", "src/card.test.jsx", "src/qty.test.jsx", "src/close.test.jsx", "src/crossing.test.jsx", "src/figures.test.jsx"];
